...
var
  ...
  //Variável que irá receber o codigo_login da tabela tbacesso
  codigo_login:integer;
  //Variável que irá armazenar o nome do projeto do tbprojeto
  nome_projeto:string;
  //Variável que irá armazenar o codigo do projeto do tbprojeto
  codigo_projeto:string;
  //Variável que irá armazenar o modelo de desenvolvimento
...
begin
  //Inicia a variável nome_projeto vazia para carregar o nome do projeto
  nome_projeto:='';
  //Centraliza form
...
var
//Variável que irá armazenar o resultado do messagedlg
resposta:integer;
begin
  //Armazena o nome do projeto do dbgrid na variável
  nome_projeto:=(gridProjeto.Columns.Items[0].Field).AsString;;
  //Excluir o projeto segundo confirmação
...
var
//Variávels que irão armazenar data e hora para tbProjetoAcesso
data, hora:string;
begin
  //Armazena o nome do projeto do dbgrid na variável
  nome_projeto:=(gridProjeto.Columns.Items[0].Field).AsString;
  //Se não houver nenhum projeto selecionado
  if (nome_projeto='') then
  begin
    messagedlg('Por favor, dê dois cliques em um projeto na lista!',mtinformation,mbokcancel,0);
    abort;
  end;
